...
namespace VCS2022_Baigiamasis.Page
{
    class SafloraPrekiuKrepselioIstustinimasPage : BasePage
    {
        ...
        private IWebElement _preke => Driver.FindElement(By.CssSelector("#page > ul > li.col4.product.post-608.product.type-product.status-publish.has-post-thumbnail.product_cat-brandziai-odai.product_cat-hidrolatai.product_cat-sausai-odai.instock.purchasable.product-type-simple > div.product_in.fade_woo > a.woocommerce-LoopProduct-link.woocommerce-loop-product__link"));
        private IWebElement _prekeIKrepseli => Driver.FindElement(By.CssSelector("#product-610 > div.summary.entry-summary > div.cart_add > form > button"));
